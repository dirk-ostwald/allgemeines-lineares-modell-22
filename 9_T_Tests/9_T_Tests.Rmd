...
einer nichtzentralen $t$-Verteilung $t(d,n-1)$ mit Nichtzentralitätsparameter
\begin{equation}
...
* Man wählt einen Mindestparameterwert $d^*$, den man mit $\pi(d,n) = b$ detektieren möchte.

* Ein konventioneller Wert ist $b = 0.8$.

* Man liest die für $\pi(d = d^*,n) = b$ nötige Stichprobengröße $n$ ab.
